    ...
    return(
      <Container style={{marginTop: 20}}>
        <div className="card">
          ...
          <div style={{marginTop: 10}}><a href="https://t.me/joinchat/NeUKX1EKpn9Bk03V2JldlA" target="_blank">Join our Free Telegram Group for daily insights and to get your questions answered in light speed.</a></div>
