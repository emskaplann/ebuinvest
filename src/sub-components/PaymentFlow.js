  ...
  return(
    ...
    <div className="card">
      <div className="card-body">
        ...
        <div style={{marginTop: 12}}><b>4 -</b> In the form we ask for basic information like Telegram username, TradingView username, etc. We ask Telegram username for <b>Telegram Group</b>, where you can ask anything and where you will meet your <b>new community.</b></div>
        <div style={{marginTop: 12}}><b>5 -</b> Now you should wait for an invitation that will come from <a href="https://www.tradingview.com/u/EbuInvest/" target="_blank" rel="noopener noreferrer"><b>@EbuInvest</b></a> on TradingView. The invitation will deliver in less than <b>12 hours.</b> After you get the invitation you can follow our <b><Link to="/how-to">guide</Link></b> to set up and test our indicator. And there are <b>no limitations</b> on the free trial. To see how to set up or take action based on our Indicator, please visit <Link to="/how-to"><b>here.</b></Link></div>
