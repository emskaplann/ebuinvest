  ...
  return(
    ...
    <div className="card">
      <div className="card-body">
        ...
        <br />
        <b>How is The Flow?</b>
        <div style={{marginTop: 5}}><b>1 -</b> After you choose and complete the PayPal or Stripe(Credit/Debit) process, we'll send you an automated e-mail that contains a <b>form link.</b></div>
        ...
        <div style={{marginTop: 12}}><b>2 -</b> In this step, <u>if you don't have a <b><a href="https://www.tradingview.com/" target="_blank" rel="noopener noreferrer">TradingView</a></b> Account, you need to register with an account to fill the form.</u> You can sign up <a href="https://www.tradingview.com/" target="_blank" rel="noopener noreferrer"><b>here.</b></a></div>
        <div style={{marginTop: 12}}><b>3 -</b> After you have the account you can fill the form that we send you through e-mail. <b>You should use the same e-mail address that you used for payment.</b> If you didn't get the e-mail, please contact us from <Link to="/reach-us"><b>here.</b></Link></div>
