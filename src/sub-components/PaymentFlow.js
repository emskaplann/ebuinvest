  ...
  return(
    ...
    <div className="card">
      <div className="card-body">
        ...
        <div style={{marginTop: 12}}><b>2 -</b> In this step, <u>if you don't have a TradingView Account, you need to open an account to fill the form.</u> You can open the account from <a href="https://www.tradingview.com/" target="_blank">here.</a></div>
        <div style={{marginTop: 12}}><b>3 -</b> You need fill the form that we send you with the e-mail. <b>And keep in mind you should put the e-mail address that you have PayPal account on.</b> If you didn't get the mail, please contact us from <Link to="/reach-us">here.</Link></div>
        ...
        <div style={{marginTop: 12}}><b>5 -</b> With the link you get you can follow our <b>guide</b> to setup and test our indicator. And there is <b>no limitations</b> on Free Trial.</div>
        <div style={{marginTop: 12}}><b>6 -</b> If you still have question(s) please don't hesitate to contact us from <b>contact@ebuinvest.com</b>. We will try our best to reply ASAP.</div>
      </div>
    </div>
    </>
  )
