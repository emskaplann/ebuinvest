  ...
  return(
    ...
    <div className="card">
      <div className="card-body">
        ...
        <div style={{marginTop: 5}}><b>3 -</b> In the e-mail you'll also find an another link for <b>Telegram Group</b>, where you can ask anything and where you meet your <b>new community.</b></div>
