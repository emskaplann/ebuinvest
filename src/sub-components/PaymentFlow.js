  ...
  return(
    ...
    <div className="card">
      <div className="card-body">
        ...
        <div style={{marginTop: 12}}><b>5 -</b> Now you should wait for invitation that will be come from <a href="https://www.tradingview.com/u/EbuInvest/" target="_blank" rel="noopener noreferrer"><b>@EbuInvest</b></a> on TradingView, it will not take more than 12 hours. After you get the invitation you can follow our <b><Link to="/how-to">guide</Link></b> to setup and test our indicator. And there is <b>no limitations</b> on Free Trial. To see how to setup or take actions based on our Indicator, please visit <Link to="/reach-us"><b>here.</b></Link></div>
